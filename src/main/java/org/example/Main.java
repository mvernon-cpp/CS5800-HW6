...
//        System.out.println("\nUsers can undo the last message they sent using the Memento design pattern.\n============================================================");
        ...
        System.out.println("\nGetting entire chat history of user person1...");
        System.out.println( person1.getEntireChatHistory() );

        System.out.println("\nGetting chat history of person5 from person1...");
        System.out.println( person5.printChatHistoryFromUser( person1.getUserName() ) );
    }
}